        ...
        <div class="content">
            ...
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <a href="addadvertising" class="btn btn-primary shadow-md mr-2">Add university</a>
                </div>
            </div>
                    ...
                    <table class="table">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th class="whitespace-nowrap">Image 1</th>
                                <th class="whitespace-nowrap">Image 2</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php echo $poss ?></td>
                                    <td><img src="../publicidad/<?php echo  $row['public1']; ?>" alt="Advertising 1" style="width: 180px;" ></td>
                                    <td>
                                        <img src="../publicidad/<?php echo $row['public1']; ?>" alt="Advertising 2" style="width: 180px;">
                                    </td>
                                    <td><a class="delete flex items-center text-danger" href="action.php?action=deletePubli&id=<?php echo $row['id']; ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="trash-2" data-lucide="trash-2" class="lucide lucide-trash-2 w-4 h-4 mr-1">
