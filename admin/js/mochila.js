...
function openProfile() {
    const university_item = $("#university_item");
    const mochila_container = $("#mochila_container");
    mochila_container.toggleClass('ver_mochila');
    university_item.removeClass('option-active');
...
function viewDetalis(item) {
    ...
    switch (item) {
        case 'account':
            ...
            // Recorrer todos los elementos de la NodeList y agregar la clase
            account_items.forEach(function (item) {
                item.classList.add('option-active');
            });

            // Remover la clase 'option-active' de los elementos de universidad
        ...
        case 'list_uni':
            ...
            // Remover la clase 'option-active' de los elementos de cuenta
            account_items.forEach(function (item) {
                item.classList.remove('option-active');
            });
            break;
