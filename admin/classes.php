        ...
        <div class="content">
            <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <a href="addvideo" class="btn btn-primary shadow-md mr-2">Add classes</a>
                </div>
            </div>
                    ...
                    <table class="table">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th class="whitespace-nowrap">Título del video</th>
                                <th class="whitespace-nowrap">Recurso</th>
                        ...
                        <tbody>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                $poss++;
                                // $eliminar=deleteVideo($row['id']);
                            ?>
                                <tr>
                                    <td><?php echo $poss ?></td>
                                    <td><?php echo $row['titulo']; ?></td>
                                    <td> <a href="<?php echo 'video/' . $row['archivo']; ?>" download="">Descargar</a> </td>
                                    <td>

                                        <a class="delete flex items-center text-danger" href="action.php?action=eliminarvideo&id=<?php echo $row['id']; ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="trash-2" data-lucide="trash-2" class="lucide lucide-trash-2 w-4 h-4 mr-1">
