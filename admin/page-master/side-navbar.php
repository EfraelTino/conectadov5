    ...
    <ul>
        <li>
            ...
            <ul class="side-menu__sub-open">
                ...
                <li>
                    <a href="universities" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="side-menu__title"> Registered Universities </div>
                    </a>
                </li>
                <li>
                    <a href="classes" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="side-menu__title">List of video classes</div>
                    </a>
                </li>
                <li>
                    <a href="suggestion" class="side-menu">
                        <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
