            ...
            <div class="wrap-general">
                ...
                <div class="wrap-info">
                    ...
                    <div class="wrap-clases">
                        ...
                        <div class="see_more">
                            <div class="see_more class_Seemore">
                                <button id="btnAntesSrc" class="btn_see prev_video"><span class="icon-chevron-left"></span>Prev</button>
                                <button id="btnSiguienteSrc" class="btn_see next_video">Next <span class="icon-chevron-right"></span></button>
                            </div>
                        </div>
                    </div>
                </div>
