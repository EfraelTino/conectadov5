...
<body>
	...
	<div class="container-emojis" id="todos_emojis">
		...
		<button id="suggestion_button" class="emoji-button button_suggestion" onclick="showSuggestion();">
			<p class="text_suggestion">Suggestion box</p>
		...
		<!-- mochila(); -->
		<button class="btn_camera maleta_button" onclick="openProfile(1);">
		<p class="text_backpack">Backpack</p>
			<img src="images/maleta2.webp" alt="greeting icon" class="icon-greting">
		</button>
		<button class="btn_camera btn_call_llamada" onclick="openProfile(3);">
		<p class="text_videocall">Video call</p>
			<img src="images/callwebp.webp" alt="greeting icon" class="icon-greting">
		</button>
		<button class="btn_camera btn_lg" onclick="logOut();">
		<p class="text_logout">Logout</p>
	...
	<?php if (isset($_SESSION['userid']) && $_SESSION['userid']) { ?>
		<button id="abrir_chat" class="flotante chat_flotante" onclick="openChat()">
